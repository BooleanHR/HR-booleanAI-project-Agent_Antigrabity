---
name: 306-three-tier-architecture-rules
...
## See also:
- [301-spring-boot-java-rules.md](301-spring-boot-java-rules.md) for general Java/Spring rules
- [303-database-mysql-jpa-rules.md](303-database-mysql-jpa-rules.md) for database design rules
- [304-api-rest-design-rules.md](304-api-rest-design-rules.md) for API design rules
