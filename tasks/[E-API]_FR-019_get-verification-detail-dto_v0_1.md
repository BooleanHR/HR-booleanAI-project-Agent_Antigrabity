...
- SRS 문서: [`SRS-HR-AI-Verification-v1.3.md#§3.7 API Overview (GET /api/verifications/[job_id])`](../SRS-HR-AI-Verification-v1.3.md)
...
---
*Document Version: v0.1 (초안) | Source: TASK-LIST C-003 | SRS: v1.3*
