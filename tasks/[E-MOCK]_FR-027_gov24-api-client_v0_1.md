...
- **목적:** 정부24 API 실제 호출 클라이언트를 구현한다. `callGov24Api(docNum, issueDate)` 함수로 문서확인번호·발급일자 기반 진위확인을 수행하며, **10초 타임아웃** 시 자동으로 Mock 폴백하는 로직을 포함한다. v1.3: agency_config.json 기반 동적 URL/셀렉터 로드. 4단계 폴백 전략 적용.
- **설계 원칙:** SRS §3.12 AgencyApiClient. §1.2 Mock 대체 원칙 — 실제 API 미연동 시 Mock으로 대체.

## :link: References (Spec & Context)
- SRS 문서: [`SRS-HR-AI-Verification-v1.3.md#§3.12 Class Diagram — AgencyApiClient`](../SRS-HR-AI-Verification-v1.3.md)
- SRS 문서: [`SRS-HR-AI-Verification-v1.3.md#§1.2 Mock 대체`](../SRS-HR-AI-Verification-v1.3.md)
- SRS 문서: [`SRS-HR-AI-Verification-v1.3.md#§3.13 REQ-FUNC-011`](../SRS-HR-AI-Verification-v1.3.md) — 10초 타임아웃 시 Mock 폴백
...
---
*Document Version: v0.1 (초안) | Source: TASK-LIST D-001 | SRS: v1.3*
