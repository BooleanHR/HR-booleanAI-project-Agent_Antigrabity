---
name: Feature Task
title: "[Feature] FR-023: POST /api/notifications/send Request/Response DTO 정의"
labels: 'feature, api-contract, priority:high'
version: v0.1
status: 초안 — 검수 대기
source_task_id: C-007
---

## :dart: Summary
- **기능명:** [FR-023] POST /api/notifications/send Request/Response DTO 정의
- **Epic:** API Contract
- **목적:** 선택적 불일치 안내 발송 API의 Request DTO(job_ids[], custom_message?)와 Response(SendResult: total, sent, failed)를 정의한다.
