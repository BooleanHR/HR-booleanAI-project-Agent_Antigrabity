---
name: Feature Task
title: "[Feature] FR-079: Notification preview modal UI"
labels: 'feature, notification, priority:high'
version: v0.1
status: "초안 — 검수 대기"
source_task_id: UI-031
---

## :dart: Summary
- **기능명:** [FR-079] Notification preview modal UI
- **Epic:** Notification
- **목적:** Dialog showing mismatch reasons + remediation guidance + custom_message edit area. src/components/notification/preview-modal.tsx.
- **설계 원칙:** SRS REQ-FUNC-103
- **복잡도:** M
...
---
*Document Version: v0.1 (초안) | Source: TASK-LIST UI-031 | SRS: v1.3*
