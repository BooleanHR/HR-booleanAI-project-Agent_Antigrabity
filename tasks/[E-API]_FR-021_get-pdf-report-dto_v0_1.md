---
name: Feature Task
title: "[Feature] FR-021: GET /api/reports/[batch_id]/pdf Response 정의"
labels: 'feature, api-contract, priority:high'
version: v0.1
status: 초안 — 검수 대기
source_task_id: C-005
---

## :dart: Summary
- **기능명:** [FR-021] GET /api/reports/[batch_id]/pdf Response 정의
- **Epic:** API Contract
- **목적:** PDF 리포트 다운로드 API의 Response(PDF Buffer stream) 형식을 정의한다. Content-Type: application/pdf, Content-Disposition: attachment.
- **설계 원칙:** §3.7 API Overview (GET /api/reports/[batch_id]/pdf)에 정의된 API 스펙을 TypeScript 인터페이스로 구현한다.

## :link: References (Spec & Context)
- SRS 문서: [`SRS-HR-AI-Verification-v1.3.md#§3.7 API Overview (GET /api/reports/[batch_id]/pdf)`](../SRS-HR-AI-Verification-v1.3.md)
...
---
*Document Version: v0.1 (초안) | Source: TASK-LIST C-005 | SRS: v1.3*
