...
- SRS 문서: [`SRS-HR-AI-Verification-v1.3.md#§3.7 API Overview (POST /api/verifications/[job_id]/approve)`](../SRS-HR-AI-Verification-v1.3.md)
...
---
*Document Version: v0.1 (초안) | Source: TASK-LIST C-004 | SRS: v1.3*
